...
(cl:defmethod cl:initialize-instance :after ((m <ranges>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ranges)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package_303770-msg:<ranges> is deprecated: use package_303770-msg:ranges instead.")))

(cl:ensure-generic-function 'ranges-val :lambda-list '(m))
(cl:defmethod ranges-val ((m <ranges>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package_303770-msg:ranges-val is deprecated.  Use package_303770-msg:ranges instead.")
  (ranges m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ranges>)))
  ...
  (cl:format cl:nil "float32[] ranges~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ranges)))
  "Returns full string definition for message of type 'ranges"
  (cl:format cl:nil "float32[] ranges~%~%"))
