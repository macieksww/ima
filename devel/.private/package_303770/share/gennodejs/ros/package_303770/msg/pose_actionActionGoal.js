...
class pose_actionActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = pose_actionGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new pose_actionActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = pose_actionGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new pose_actionGoal()
    }
...
module.exports = pose_actionActionGoal;
