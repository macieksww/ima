...
let pose_actionAction = require('./pose_actionAction.js');
let pose_actionActionGoal = require('./pose_actionActionGoal.js');
let pose_actionGoal = require('./pose_actionGoal.js');
...
module.exports = {
  ...
  pose_actionAction: pose_actionAction,
  pose_actionActionGoal: pose_actionActionGoal,
  pose_actionGoal: pose_actionGoal,
  pose_actionActionFeedback: pose_actionActionFeedback,
};
